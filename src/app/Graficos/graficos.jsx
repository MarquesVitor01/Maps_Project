...
const Dashboard = ({ clientes, exibirPagos }) => {
  // Calculate some data for the chart (you can customize this based on your requirements)
  const calcularSituacaoFinanceira = () => {
    const totalClientes = clientes.length;
    const clientesPagos = clientes.filter(cliente => cliente.pago);

    // Calculate the total value of payments for both paid and unpaid clients
