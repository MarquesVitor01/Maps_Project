    ...
    function LoginUsuario() {
        signInWithEmailAndPassword(auth, email, senha)
            .then(function (firebaseUser) {
                ...
                // Check for a specific condition (e.g., email is a specific value)
                let redirectPath = '/app/home'; // Default redirection path
                ...
                setRedirectToHome(true); // Set the state to true for redirection
                setRedirectPath(redirectPath); // Set the dynamic redirection path
            })
